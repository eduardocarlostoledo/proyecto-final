              ...
              <body style="background-color: #232326; display: flex; margin-top: 80px; flex-direction: column; align-items: center;">
                <div style="display: flex; flex-direction: column; align-items: center; text-align: center; border: 1px solid black; border-radius: 20px; background-color: #ffffff; padding: 20px;"">
                  <a style="margin-bottom: 10px;" href="http://localhost:3000/"><svg class='succes_svg' width="50px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25 25"><path style="fill:#232326" d="M24 12.001H2.914l5.294-5.295-.707-.707L1 12.501l6.5 6.5.707-.707-5.293-5.293H24v-1z" data-name="Left"/></svg></a>
                    ...
                    <a style="margin-bottom: 10px;" href="http://localhost:3000/Products" class="succes_a">Keep Buying</a>
...
payRouter.get("/feedback/pending", async function (req, res) {
  try {
    ...
    <html>
      ...
      <body style="background-color: #232326; display: flex; margin-top: 80px; flex-direction: column; align-items: center;">
        <div style="display: flex; flex-direction: column; align-items: center; text-align: center; border: 1px solid black; border-radius: 20px; background-color: #ffffff; padding: 20px;"">
          <a style="margin-bottom: 10px;" href="http://localhost:3000/"><svg class='pending_svg' width="20px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25 25"><path style="fill:#232326" d="M24 12.001H2.914l5.294-5.295-.707-.707L1 12.501l6.5 6.5.707-.707-5.293-5.293H24v-1z" data-name="Left"/></svg></a>
          <h1 style="margin-bottom: 10px;" class="pending_h1"> Pending Pay !</h1>
          <img style="max-width: 100%; margin-bottom: 10px;" class='pending_img'src="https://img.freepik.com/fotos-premium/simbolo-signo-exclamacion-azul-atencion-o-icono-signo-precaucion-fondo-problema-peligro-alerta-representacion-3d-senal-advertencia_256259-2831.jpg" alt="">
          <a style="margin-bottom: 10px;" class="pending_a" href="http://localhost:3000/Products">Keep Buying</a>
          <p style="margin-bottom: 10px;" class="pending_p">COMPUTER STORE</p>
        </div>
      </body>
    </html>
      `);
...
payRouter.get("/feedback/failure", async function (req, res) {
  try {
    ...
    <html>
      ...
      <body style="background-color: #232326; display: flex; margin-top: 80px; flex-direction: column; align-items: center;">
        <div style="display: flex; flex-direction: column; align-items: center; text-align: center; border: 1px solid black; border-radius: 20px; background-color: #ffffff; padding: 20px;"">
        <a style="margin-bottom: 10px;" href="http://localhost:3000/"><svg class='failure_svg' width="30px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25 25"><path style="fill:#232326" d="M24 12.001H2.914l5.294-5.295-.707-.707L1 12.501l6.5 6.5.707-.707-5.293-5.293H24v-1z" data-name="Left"/></svg></a>
        <h1 style="margin-bottom: 10px;" class="failure_h1"> Failure Pay!</h1>
        <img style="max-width: 100%; margin-bottom: 10px;" class="failure_img" src="https://static.vecteezy.com/system/resources/thumbnails/017/178/563/small/cross-check-icon-symbol-on-transparent-background-free-png.png" alt="">
        <a style="margin-bottom: 10px;" href="http://localhost:3000/Products" class="failure_a">Keep Buying</a>
        <p style="margin-bottom: 10px;" class="failure_p">COMPUTER STORE</p>
      </div>
      </body>
  </html>
              `);
