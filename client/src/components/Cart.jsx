...
export default function Cart() {
  ...
  // const preferencia = cartItems.map(e=> {
  //   return {
  //   product_description: e.name,
  //   product_name: e.name,
  //   product_image: e.image,
  //   product_amount: e.amount,
  //   product_unit_price: e.price,
  //   prodId: e.prodId
  // }})

  // const total_order_price = price;
  // const buyer_email = userActiveOwnerOfCart.email;
  // preferencia[total_order_price] = total_order_price
  // preferencia[buyer_email] = buyer_email;
