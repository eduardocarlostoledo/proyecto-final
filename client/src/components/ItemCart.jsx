        ...
        <div className="DivAllCards">  
            <div className="contenedor_card">
                ...
                <div className="ContainerSumRest">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-bag-dash" viewBox="0 0 16 16">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-bag-plus" viewBox="0 0 16 16">
